...
class BundleAdjustmentFpsSamplingStage(
    ...
    Drop-in alternative to :class:`BundleAdjustmentRandomSamplingStage`. Keypoints that
    ...
    def _sample_candidates_per_view(
        ...
        if runtime_cfg.sampler == "random":
            ...
            axes = [
                runtime_cfg.w_uv * uvs[..., 0] / widths,
                runtime_cfg.w_uv * uvs[..., 1] / heights,
