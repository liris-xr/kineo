...
CACHING_STAGES = {
    "moge_intrinsics_estimation.MoGeIntrinsicsEstimationStage": {
        ...
        "runtime_keys": ["use_half_precision", "shared_focal_init"],
        "token": "moge",
    },
    ...
    "rtmlib.rtmlib_bbox_detection.RtmlibBboxDetectionStage": {
        "model_keys": ["det_model_name_or_path"],
        "runtime_keys": [
            "min_bbox_score",
            "nms_iou_thr",
            "best_bbox_only",
    ...
    "rtmlib.rtmlib_keypoints_detection.RtmlibKeypointsDetectionStage": {
        "model_keys": ["keypoints_model_name_or_path"],
        "runtime_keys": ["frame_step"],
        "token": "rtmpose",
    },
    "rtmlib.rtmlib_bbox_keypoints_detection.RtmlibBboxKeypointsDetectionStage": {
        "model_keys": ["det_model_name_or_path", "keypoints_model_name_or_path"],
        "runtime_keys": [
            "min_bbox_score",
            "nms_iou_thr",
            "best_bbox_only",
    ...
    "sam2_semiauto_bbox_detection_rtmlib.SAM2SemiAutoBboxDetectionRtmlibStage": {
        "model_keys": [
            "sam2_model_cfg",
            "sam2_model_weights",
            "det_model_name_or_path",
        ],
        "runtime_keys": ["frame_step", "min_bbox_score", "nms_iou_thr"],
        "token": "sam2rtm",
    },
}
