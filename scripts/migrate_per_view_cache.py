...
mismatch is reported rather than silently overwritten.
    ...
    python scripts/migrate_per_view_cache.py \\
        ...
        --target cache/moge-nlfcoco19-fp32_4fbd05ac --apply
...
# The intrinsics cache predates the current annotation key.
LEGACY_ANNOTATION_KEYS = {"camera_intrinsics": "cameras_intrinsics"}
    ...
    for source in sources:
        for sequence_name in sorted(os.listdir(source)):
            ...
            for filename in sorted(os.listdir(sequence_dir)):
                ...
                annotation_key = LEGACY_ANNOTATION_KEYS.get(
