#!/bin/bash
#
# The EgoHumans sequences the benchmarks and ablations run over, grouped by
# activity so a runner can submit one job per activity. Source this from a
# runner script; it expects the repository root as the working directory.
